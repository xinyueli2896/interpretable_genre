...
def main() -> None:
    ...
    if decoder_enabled:
        ...
        print("Decoder disabled; skipping reconstruction.")

    # --- Concept editing ---
    if args.concept_shift_json:
        if output.concepts is None or model.concept_to_latent is None or model.decoder is None:
            raise ValueError("concept_shift_json requires concept bottleneck and decoder to be enabled.")
